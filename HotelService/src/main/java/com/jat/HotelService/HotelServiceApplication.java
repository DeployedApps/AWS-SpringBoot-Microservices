...
@EnableEurekaClient
@OpenAPIDefinition(info = @Info(title = "This is  the Hotel Microservices among 7 microservices architecture build on 2 databses postgres & mongo with spring boot deployed on AWS.. The demo show causes the complete architecture & communication in microservices. It is deployed with one click mechanism on AWS. Please contact *** Praveen *** for full demo. It is prepared with java 17, spring version 2.7.7 enabled with EUREKA SERVER, FEIGN-CLIENT, Open-API 3 & 2, CONFIG-SERVER, API-GATWAY, DOCUMENT SERVER, JWT, CIRCUIT-BREAKER, RATE LIMITERS, RETRY, SPING SECURITY & OKTA AUTH. Please feel free to choose another microservice from dropdown of main Document Server.", version = "3.0", description = "It contains Hotel Information along with ratings & other criteria. API is powered by salient features of Spring Boot e.g. [resilence4j](!https://resilience4j.readme.io/docs),"+ 
