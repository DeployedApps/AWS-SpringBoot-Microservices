...
@EnableEurekaClient
@OpenAPIDefinition(info = @Info(title = "The Hotel Microservices is among 7 microservices build for microservice architecture demo along with 2 databses (postgres & mongo)deployed on AWS. It comprises of java 17, spring version 2.7.7, EUREKA SERVER, CONFIG-SERVER, API-GATWAY, OpenAPI, DOCUMENT SERVER, JWT, CIRCUIT-BREAKER, RATE LIMITERS, RETRY, FEIGN-CLIENT, SPRING SECURITY & OKTA AUTH. Please explore other microservice from dropdown [TOP RIGHT] of main Document-Server.", version = "3.0", description = "It contains Hotel Information along with ratings & other criteria."+
		"### This demo show cause all latest strategies in microservices. ## Please contact *** Praveen *** for demo."+" API is powered by salient features of Spring Boot e.g. [resilence4j](!https://resilience4j.readme.io/docs),"+
