...
@EnableEurekaClient
@EnableFeignClients
@OpenAPIDefinition(info = @Info(title = "This is  the User Microservices among 7 microservices architecture build on 2 databses postgres & mongo with spring boot deployed on AWS. The demo show causes the complete architecture & communication in microservices. It is deployed with one click mechanism on AWS. Please contact *** Praveen *** for full demo. It is prepared with java 17, spring version 2.7.7 enabled with EUREKA SERVER, Open API docs 3 & 2, CONFIG-SERVER, API-GATWAY, COMBINED DOCUMENT SERVER, JWT, CIRCUIT-BREAKER, RATE LIMITERS, RETRY, FEIGN-CLIENT, SPING SECURITY & OKTA AUTH. Please feel free choose another microservice from dropdown [TOP RIGHT CORNER] of main Document Server to explore it further.", version = "3.0", description = "USER-SERVICE contains User Information along with Hotel information which user has provided durings his stay. The API is powered by salient features of Spring Boot e.g. [resilence4j](!https://resilience4j.readme.io/docs),"+
